...
import { MEMBERSHIP_PRICE_LABEL, TRIAL_DAYS } from "@/lib/stripe";
    ...
    <main className="grid gap-6 p-4 md:p-8">
      <section className="card">
        ...
        <p className="mt-3 max-w-2xl text-[var(--ink-soft)]">
          {TRIAL_DAYS} days free, then {MEMBERSHIP_PRICE_LABEL}. Unlocks every zone,
          every printable, every reward — for one little explorer or a whole family.
        </p>
